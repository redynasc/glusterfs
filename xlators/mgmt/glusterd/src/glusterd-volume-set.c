...
struct volopt_map_entry glusterd_volopt_map[] = {
    ...
    {.key = "performance.fsc-pass-through",
     ...
     .op_version = 1,
     .flags = VOLOPT_FLAG_CLIENT_OPT},
    {.key = "performance.fsc-lookup-local",
     .voltype = "performance/fs-cache",
     .op_version = 1,
     .flags = VOLOPT_FLAG_CLIENT_OPT},
    {.key = "performance.fsc-cache-dir",
     ...
     .op_version = 1,
     .flags = VOLOPT_FLAG_CLIENT_OPT},
    {.key = "performance.fsc-cache-filter",
     .voltype = "performance/fs-cache",
     .op_version = 1,
     .flags = VOLOPT_FLAG_CLIENT_OPT},
    {.key = "performance.fsc-disk-reserve",
     ...
     .op_version = 1,
     .flags = VOLOPT_FLAG_CLIENT_OPT},
    {.key = "performance.fsc-resycle-idle-inode",
     .voltype = "performance/fs-cache",
     .op_version = 1,
     .flags = VOLOPT_FLAG_CLIENT_OPT},
    {.key = "performance.fsc-time-idle-inode",
     .voltype = "performance/fs-cache",
     .op_version = 1,
     .flags = VOLOPT_FLAG_CLIENT_OPT},
    {.key = "performance.fsc-direct-io-write",
     .voltype = "performance/fs-cache",
     .op_version = 1,
     .flags = VOLOPT_FLAG_CLIENT_OPT},
    ...
    {.key = "performance.readdir-ahead",
     ...
     .flags = VOLOPT_FLAG_CLIENT_OPT | VOLOPT_FLAG_XLATOR_OPT},
    {.key = "performance.fs-cache",
     .voltype = "performance/fs-cache",
     .option = "!perf",
     .value = "off",
     .op_version = 1,
     .description = "enable/disable fs-cache translator in the volume.",
     .flags = VOLOPT_FLAG_CLIENT_OPT},
